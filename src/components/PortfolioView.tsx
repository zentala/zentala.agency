  ...
  const allItems = [
    {
      title: "Robot Merch",
      description: <Space>
        <Paragraph>Functional prototype of a socially-aware humanoid robot tailored for events and retail applications, enhancing its situational awareness through bespoke IoT integrations.</Paragraph>
        <Paragraph>The robot stood 1.6 metres tall and operated on a dual-servo system, incorporating a two-axis articulated head, touchscreen interface, touch-sensitive sensors and a docking (charging) station.</Paragraph>
        <Paragraph>The culmination of this four-month project was the result of a dynamic partnership: myself, a temporary software contractor tasked with software development of the robot, and Ula, a dedicated Cheil employee serving as R&D Art Director. Ula played a pivotal role in shaping the concept and design of this innovative robotic solution.</Paragraph>
        <Paragraph>We collaborated directly on the physical construction of the robot, starting with hardware decisions, continuing with the fabrication of the robot's skeleton and enclosure using CNC milling and 3D printing techniques, and ending with the final machine assembly.</Paragraph>
      </Space>,
      categories: ["Hardware"],
      technologies: ["Linux", "ROS (Robotic Operating System)", "ROS2", "Python", "C/C++", "Computer Vision", "Machine Learning", "TensorFlow", "SLAM", "YOLO", "Electronics", "LIDAR", "Intel RealSense Cameras (T265 & D435)", "NVIDIA Jetson", "3D Printing", "CNC Milling", "AUTODESK Fusion 360", "React.js"],
    ...
    },
    {
      ...
      description: "An innovative, sensor-equipped desk that adjusts its height based on the user's time spent in front of the computer. It can suggest breaks or raise itself autonomously to encourage standing work.",
    ...
    },
    {
      ...
      demoLink: "",
      image: "https://media.licdn.com/dms/image/D4D2DAQFckFI-WS9y0Q/profile-treasury-image-shrink_800_800/0/1692935629000?e=1699416000&v=beta&t=fCravADLlN6jZpH88gkMoyVlVrQkc5vRgzZHzh3gTjU",
    ...
    },
    {
      ...
      image: "https://media.licdn.com/dms/image/D4D2DAQFb9Yt3geSE7w/profile-treasury-image-shrink_800_800/0/1692936221851?e=1699416000&v=beta&t=D-x833OdnbZbCSqncB3EeSKyz3wkYuyG0pfT8Yle4w4",
      technologies: ["WordPress"],
