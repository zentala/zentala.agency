...
import { getBubbleButtonSize } from '@/components/solid-chat/utils'
  ...
  return (
    <>
      ...
      <div
        ...
        class={
          `fixed max-h-[704px] w-full rounded-lg sm:right-5 sm:w-[400px]` +
          (isBotOpened() ? ' opacity-1' : ' pointer-events-none opacity-0') +
        ...
        <Show when={isBotStarted()}>
          <div class="relative h-full">
            <Show when={isBotOpened()}>
              ...
              <button
                onClick={closeBot}
                class="absolute right-[-8px] top-0 z-50 m-[6px] rounded-full bg-transparent py-2 pr-3 text-white filter transition-all hover:brightness-90 active:brightness-75 disabled:cursor-not-allowed disabled:opacity-50 disabled:brightness-100"
                title="Close Chat"
              >
            ...
            <Bot
              ...
              titleBackgroundColor={
                bubbleProps.theme?.chatWindow?.titleBackgroundColor
              }
