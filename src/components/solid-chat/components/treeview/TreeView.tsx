...
export const TreeItem = (props: TreeItemProps) => {
  ...
  return (
    <div class="tree-item-root">
      <div
        class="tree-item-content flex cursor-pointer items-center rounded px-1 py-2 hover:bg-gray-100"
        onClick={() => hasChildren && context.toggleItem(props.itemId)}
      >
        <div
          class="tree-item-icon-container mr-1"
          style={{ visibility: hasChildren ? 'visible' : 'hidden' }}
        >
          <Dynamic
            component={
              context.isExpanded(props.itemId) ? ChevronDown : ChevronRight
            }
          />
        </div>
