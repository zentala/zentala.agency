    ...
    <div style={styles.container}>
      ...
      >
        ...
        <g transform="translate(0.000000,111.000000) scale(0.100000,-0.100000)" stroke="none" fill={color}>
          ...
          <path d="M588 833 c-42 -59 -99 -141 -127 -180 l-52 -73 79 0 78 0 81 117 81 116 -24 56 c-14 31 -29 60 -33 64 -4 4 -42 -41 -83 -100z" />{' '}
          <path d="M1430 555 l0 -65 295 0 295 0 0 65 0 65 -295 0 -295 0 0 -65z" />
      ...
      <div style={styles.supplement}>{supplement}</div>
    </div>
  )
