    ...
    <Layout>
      <section>
        <div className="wrapper">
          ...
          <Paragraph>
            Data ostatniej aktualizacji: <strong>27 października 2023</strong>
          </Paragraph>
          ...
          <Paragraph>Nie udostępniamy Twoich danych osobowych trzecim stronom bez Twojej wyraźnej zgody.</Paragraph>
          ...
          <Paragraph>
            Zastrzegamy sobie prawo do wprowadzenia zmian w Polityce Prywatności. Wszelkie zmiany będą publikowane na
            tej stronie.
          </Paragraph>
