...
import {
  isNotDefined,
  getBubbleButtonSize,
} from '@/components/solid-chat/utils/index'
  ...
  return (
    <Show when={!isSmallScreen() || !props.isBotOpened} keyed>
      <button
        ...
        class={`animate-fade-in fixed flex items-center justify-center rounded-full shadow-md transition-transform duration-200 hover:scale-110 active:scale-95`}
        style={{
      ...
      >
        <Show when={isNotDefined(props.customIconSrc)} keyed>
          <svg
            ...
            class={
              `absolute fill-transparent stroke-2 transition duration-200 ` +
              (props.isBotOpened
                ? 'scale-0 opacity-0'
