...
export const TreeItem = (props: TreeItemProps) => {
  ...
  const getDefaultIcon = () => {
    ...
    return (
      <>
        {context.isExpanded(props.itemId) ? <FolderOpenIcon /> : <FolderIcon />}
      </>
    )
  }
  ...
  return (
    <div class="tree-item-root">
      <div
        class={`tree-item-content flex cursor-pointer items-center rounded px-1 py-2 ${context.isSelected(props.itemId) ? 'selected' : ''} ${
